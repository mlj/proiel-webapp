...
#      sentence.remove_syntax_and_info_structure!
  ...
  # Guesses morphological features using the morphological guessing resources
  # tools that have been configured for the language in question.
  def guess_morphology!(overlaid_morph_features = nil)
    language.guess_morphology(form,
                              current_features: morph_features,
                              feature_mask: source_morph_features,
                              overlaid_features: overlaid_morph_features)
  end
