...
class SentenceTest < ActiveSupport::TestCase
  ...
  def test_next_previous
    ...
    assert_equal @sentence_middle_of_sd, @sentence_first_in_sd.next_sentence
    assert_equal @sentence_last_in_sd, @sentence_middle_of_sd.next_sentence
    assert_equal @sentence_extra_last_in_sd, @sentence_last_in_sd.next_sentence
    assert_equal nil, @sentence_extra_last_in_sd.next_sentence
    ...
    assert_equal nil, @sentence_first_in_sd.previous_sentence
    assert_equal @sentence_first_in_sd, @sentence_middle_of_sd.previous_sentence
    assert_equal @sentence_middle_of_sd, @sentence_last_in_sd.previous_sentence
    assert_equal @sentence_last_in_sd, @sentence_extra_last_in_sd.previous_sentence
  end
